...
/**
 * @file
 * Algorithms T_AB4 and T_AB8.
 */
#ifndef __ABALGORITHM_H__
#define __ABALGORITHM_H__
...
{
/**
 * The Adams-Bashforth integration method. Currently available as 4th and
 * 8th order.
